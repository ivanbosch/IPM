...
<div class='homepage_Container'>
  <?php
      ...
      if ($_SESSION['user_Type'] == 'Management') {
        ...
        <div class='homepage_Lists'>
          ...
          <ul>
            ...
            <li><a href='' target ='_blank'>Allocate Blanks</a></li>
        ...
        echo "
            <div class='homepage_Lists'>
              ...
              <ul>
                ...
                <li><a href='' target ='_blank'>Add Blanks</a></li>
      ...
      if($_SESSION['user_Type'] == 'Advisor') {
        echo "
          <div class='homepage_Lists'>
            <h2>Sales</h2>
            <ul>
              <li><a href='' target ='_blank'>Create Sale</a></li>
    ...
    if (isset($_SESSION['user_Type'])) {
      if($_SESSION['user_Type'] == 'Advisors' || $_SESSION['user_Type'] == 'Management') {
        echo "
          <div class='homepage_Lists'>
            <h2>Reports</h2>
            <ul>
