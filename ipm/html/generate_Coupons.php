...
<html lang="en" dir="ltr">
        ...
        switch (selection) {
          case '420':
            ...
            for (i = 0; i < 2; i++){
              ...
              generatedHTML += `
                  <form class='generate_Coupons' action='../PHP/coupons_Management.php' method='post'>
          ...
          case '444':
            ...
            console.log(document.getElementById("coupon_Amount").value);
            for (i = 0; i < 4; i++){
              generatedHTML += `
                  <form class='generate_Coupons' action='../PHP/coupons_Management.php' method='post'>
                    <input type='text' name='coupon_Origin${i}' placeholder='Enter Origin..'>
  ...
  <body>
    ...
    <input type="hidden" id="coupon_Amount" value="1"/>
    <form method="post" id="0" action="../PHP/coupons_Management.php"></form>
